local Translations = {
    error = {
        ...
        ["inside_veh"] = "Você não pode consertar um motor de veículo de dentro!",
        ["healthy_veh"] = "O veículo está muito saudável e precisa de ferramentas melhores!",
        ["inside_veh_req"] = "Você deve estar dentro de um veículo para consertá-lo!",
        ["roadside_avail"] = "Há assistência na estrada disponível, chame através do seu celular!",
        ...
        ["nofix_message_1"] = "Você verificou o nível de óleo e parecia normal",
        ["nofix_message_2"] = "Você olhou para sua bicicleta e nada parece errado",
        ["nofix_message_3"] = "Você olhou para a fita adesiva na mangueira de óleo e parecia bem",
    ...
    success = {
        ...
        ["fix_message_7"] = "Você gritou com o carro, e ele voltou a funcionar",
    },
    progress = {
